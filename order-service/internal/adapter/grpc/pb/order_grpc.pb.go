...
const (
	...
	OrderService_ListOrdersByRestaurant_FullMethodName = "/order.OrderService/ListOrdersByRestaurant"
)
...
type OrderServiceClient interface {
	...
	ListOrdersByRestaurant(ctx context.Context, in *ListOrdersByRestaurantRequest, opts ...grpc.CallOption) (*ListOrdersByRestaurantResponse, error)
}
...
func (c *orderServiceClient) ListOrdersByRestaurant(ctx context.Context, in *ListOrdersByRestaurantRequest, opts ...grpc.CallOption) (*ListOrdersByRestaurantResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListOrdersByRestaurantResponse)
	err := c.cc.Invoke(ctx, OrderService_ListOrdersByRestaurant_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type OrderServiceServer interface {
	...
	ListOrdersByRestaurant(context.Context, *ListOrdersByRestaurantRequest) (*ListOrdersByRestaurantResponse, error)
...
func (UnimplementedOrderServiceServer) ListOrdersByRestaurant(context.Context, *ListOrdersByRestaurantRequest) (*ListOrdersByRestaurantResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListOrdersByRestaurant not implemented")
}
...
func _OrderService_ListOrdersByRestaurant_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListOrdersByRestaurantRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OrderServiceServer).ListOrdersByRestaurant(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: OrderService_ListOrdersByRestaurant_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).ListOrdersByRestaurant(ctx, req.(*ListOrdersByRestaurantRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var OrderService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ListOrdersByRestaurant",
			Handler:    _OrderService_ListOrdersByRestaurant_Handler,
		},
	},
